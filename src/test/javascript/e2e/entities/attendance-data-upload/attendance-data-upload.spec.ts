...
describe('AttendanceDataUpload e2e test', () => {
  ...
  it('should create and save AttendanceDataUploads', async () => {
    ...
    await promise.all([
      attendanceDataUploadUpdatePage.setFileUploadInput(absolutePath),
      attendanceDataUploadUpdatePage.setCreatedOnInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
    ]);
    ...
    expect(await attendanceDataUploadUpdatePage.getCreatedOnInput()).to.contain(
      '2001-01-01T02:30',

...
public class AttendanceDataUploadResourceIT {
    ...
    public void createAttendanceDataUpload() throws Exception {
        ...
        assertThat(testAttendanceDataUpload.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
    }
    ...
    public void updateAttendanceDataUpload() throws Exception {
        ...
        assertThat(testAttendanceDataUpload.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
    }

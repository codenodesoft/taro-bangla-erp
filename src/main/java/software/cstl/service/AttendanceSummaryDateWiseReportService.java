...
@Service
@Transactional
public class AttendanceSummaryDateWiseReportService {

    private final Logger log = LoggerFactory.getLogger(AttendanceSummaryDateWiseReportService.class);
    ...
    public AttendanceSummaryDateWiseReportService(AttendanceSummaryQueryService attendanceSummaryQueryService) {
    ...
    public ByteArrayInputStream download(AttendanceSummaryCriteria criteria) throws DocumentException {
        LocalDate start = criteria.getAttendanceDate().getGreaterThanOrEqual();
        LocalDate end = criteria.getAttendanceDate().getLessThanOrEqual();
        ...
        writer.setPageEvent(new Heading(start.toString() + " to " + end.toString()));
        document.open();
    ...
    static class Heading extends PdfPageEventHelper {
        ...
        public void onStartPage(PdfWriter writer, Document document) {
            ...
            phrase = new Phrase("Attendance Report", TIMES_BOLD_14);

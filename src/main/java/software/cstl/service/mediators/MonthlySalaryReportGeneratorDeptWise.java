...
@Slf4j
public class MonthlySalaryReportGeneratorDeptWise {
    ...
    public ByteArrayInputStream createSalaryReport(String departmentName, String startDate, String endDate, List<SalaryReportDto> salaryReport) throws DocumentException, IOException {
    ...
    private PdfPTable getPageHeader(MonthlySalary monthlySalary) throws DocumentException, IOException {
        ...
        Font bengaliFont = new Font(baseFont, 13);

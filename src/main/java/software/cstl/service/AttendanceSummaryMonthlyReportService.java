...
@Service
@Transactional
public class AttendanceSummaryMonthlyReportService {

    private final Logger log = LoggerFactory.getLogger(AttendanceSummaryMonthlyReportService.class);
    ...
    public AttendanceSummaryMonthlyReportService(AttendanceSummaryQueryService attendanceSummaryQueryService) {
        this.attendanceSummaryQueryService = attendanceSummaryQueryService;
    }

    public ByteArrayInputStream download(AttendanceSummaryCriteria criteria, int monthId, int yearId) throws DocumentException {
        CommonService commonService = new CommonService();
        LocalDate firstDayOfMonth = commonService.getFirstDayOfTheMonth(yearId, monthId);
        LocalDate lastDayOfMonth = commonService.getLastDayOfTheMonth(yearId, monthId);
        ...
        writer.setPageEvent(new Heading(Month.of(monthId) + ", " + yearId));
        document.open();
    ...
    static class Heading extends PdfPageEventHelper {
        ...
        public void onStartPage(PdfWriter writer, Document document) {
            ...
            phrase = new Phrase("Attendance Monthly Report", TIMES_BOLD_14);

...
public class UnicodeToAnsiConverterUtil {
    ...
    private static Map<String, String> preConversionMapRev = new HashMap<String, String>();
    private static Map<String, String> conversionMapRev = new HashMap<String, String>();
    private static Map<String, String> proConversionMapRev = new HashMap<String, String>();
    private static Map<String, String> postConversionMapRev = new HashMap<String, String>();
    ...
    static {
        ...
        for(Map.Entry<String, String> entrySet: preConversionMap.entrySet()){
            preConversionMapRev.put(entrySet.getValue(), entrySet.getKey());
        }
...
// Vowels Start
        ...
        for(Map.Entry<String, String> entry: conversionMap.entrySet()){
            conversionMapRev.put(entry.getValue(), entry.getKey());
        }

        proConversionMap.put("্্", "্");
        proConversionMapRev.put("্","্্");
        ...
        for(Map.Entry<String, String> entry: postConversionMap.entrySet()){
            postConversionMapRev.put(entry.getValue(), entry.getKey());
        }
    }
    ...
    private static String reArrangeUnicodeConvertedTextForAnsi(String str) {

        for (int i = 0; i < str.length(); ++i) {

            // Change refs
            if (i < (str.length() - 1) && isBanglaPreKar(str, i)) {
                int j = 1;
                while (true) {
                    if (i - j < 0) {
                        break;
        ...
        str = doCharMap(str, proConversionMapRev);
     ...
     */
    public static String convertFromBijoyToUnicode(String bijoyString) {
    ...
    public static String convertFromUnicodeToAnsi(String unicodeString) {

        unicodeString = doCharMap(unicodeString, preConversionMapRev);
        unicodeString = doCharMap(unicodeString, conversionMapRev);
        unicodeString = reArrangeUnicodeConvertedTextForAnsi(unicodeString);
        unicodeString = doCharMap(unicodeString, postConversionMapRev);
        return unicodeString;
    }

    public static String convertFromUnicodeToAnsiV2(String unicodeString){
        String pattern = "ো";
        String replacement = "ো";
        unicodeString = unicodeString.replaceAll(pattern, replacement);

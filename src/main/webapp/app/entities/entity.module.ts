...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'attendance-synchronization',
        loadChildren: () =>
          import('./attendance-synchronization/attendance-synchronization.module').then(m => m.CodeNodeErpAttendanceSynchronizationModule),
      },

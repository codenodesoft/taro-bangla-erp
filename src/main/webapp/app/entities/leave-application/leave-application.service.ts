...
export class LeaveApplicationService {
  ...
  protected convertDateFromClient(leaveApplication: ILeaveApplication): ILeaveApplication {
    const copy: ILeaveApplication = Object.assign({}, leaveApplication, {
      ...
      appliedOn: leaveApplication.appliedOn && leaveApplication.appliedOn.isValid() ? leaveApplication.appliedOn.toJSON() : undefined,
      actionTakenOn:
        leaveApplication.actionTakenOn && leaveApplication.actionTakenOn.isValid() ? leaveApplication.actionTakenOn.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.actionTakenOn = res.body.actionTakenOn ? moment(res.body.actionTakenOn) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((leaveApplication: ILeaveApplication) => {
        ...
        leaveApplication.appliedOn = leaveApplication.appliedOn ? moment(leaveApplication.appliedOn) : undefined;
        leaveApplication.actionTakenOn = leaveApplication.actionTakenOn ? moment(leaveApplication.actionTakenOn) : undefined;
      });
    }
    return res;
  }

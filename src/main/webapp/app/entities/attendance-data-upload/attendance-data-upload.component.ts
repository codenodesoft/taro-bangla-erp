...
export class AttendanceDataUploadComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.attendanceDataUploadService
      ...
      .subscribe(
        (res: HttpResponse<IAttendanceDataUpload[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAttendanceDataUploads(): void {
    this.eventSubscriber = this.eventManager.subscribe('attendanceDataUploadListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAttendanceDataUpload[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/attendance-data-upload'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
    ...
    this.attendanceDataUploads = data || [];
